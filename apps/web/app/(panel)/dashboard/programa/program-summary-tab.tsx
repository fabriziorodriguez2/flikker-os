      ...
      <section className="overflow-hidden rounded-[16px] border border-[#E8EAF0] bg-white shadow-[0_2px_8px_rgba(17,22,59,0.025)]">
        <div className="flex flex-wrap items-start justify-between gap-4 px-5 py-5 sm:px-6">
          ...
          <button
            ...
            className="inline-flex h-9 items-center gap-2 rounded-[10px] border border-[#E8EAF0] bg-white px-3.5 text-sm font-semibold text-[#5C6478] shadow-[0_2px_6px_rgba(17,22,59,0.03)] hover:border-[#D9DEEA] hover:bg-[#F8F9FC] disabled:cursor-not-allowed disabled:text-[#B0B8C9] disabled:shadow-none"
          >
