...
/**
 * Staff-facing benefit validator. The employee types the code the customer
 * shows and validates it. The redemption itself (atomic, no double use) happens
 * on the API — this only surfaces the outcome.
 */
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-[#8891A4]">
            Ingresá el código que muestra el cliente para canjearlo.
          </p>
        </div>
      </div>
